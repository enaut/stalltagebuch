...
pub fn calculate_statistics(
    ...
    let (total_records, total_eggs_opt, daily_avg, min_eggs_opt, max_eggs_opt, first_date, last_date) = result;
...
mod tests {
    ...
    fn test_calculate_statistics_with_data() {
        ...
        for i in 1..=5 {
            let record = EggRecord {
                id: None,
                record_date: NaiveDate::from_ymd_opt(2025, 11, i).unwrap(),
                total_eggs: 10 + i,
                notes: None,
            };
    ...
    fn test_get_recent_trend() {
        ...
        assert_eq!(trend[0].1, 20); // Letzter Tag (10*2)
